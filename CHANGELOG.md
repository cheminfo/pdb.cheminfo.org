...
## [1.2.0](https://github.com/cheminfo/pdb.cheminfo.org/compare/v1.1.1...v1.2.0) (2026-09-26)


### Features

* **about:** one shared About at /about ([151fc2a](https://github.com/cheminfo/pdb.cheminfo.org/commit/151fc2a09eefa9dad6eedc770751615fd5f6520c))
* **about:** say which build is running ([78c2f5a](https://github.com/cheminfo/pdb.cheminfo.org/commit/78c2f5adf41b0e4a9f72fab9d17a1f40685a547c))
* add a /health probe for the deploy script ([4597659](https://github.com/cheminfo/pdb.cheminfo.org/commit/45976595da6f5cde7a6f4a666740d69484586f1a))
...
* copy values with a click and keep the tool text unselectable ([49fd547](https://github.com/cheminfo/pdb.cheminfo.org/commit/49fd547874829861555d5a8c4a60da4baaa1312c))
...
* draw structures with react-cheminfo's StructureEditor ([e661676](https://github.com/cheminfo/pdb.cheminfo.org/commit/e661676e8ef2b562048d68338564dd406f2eea54))
...
* serve under a path as well as on a host of its own ([5b290cc](https://github.com/cheminfo/pdb.cheminfo.org/commit/5b290ccbf9b5bb396afa4f43f162d2e89646cf27))
...
* share any page as a link, or as the iframe that frames it ([9087c67](https://github.com/cheminfo/pdb.cheminfo.org/commit/9087c67e3addb1add47b71919c4ef3964e1fecb0))
* support ?embed and take shared parts from react-cheminfo 0.12 ([78c1412](https://github.com/cheminfo/pdb.cheminfo.org/commit/78c14121366dd83ffa532881fd891b65f5441fbd))
...
* **chrome:** run the bar and the footer the full width of the tool ([9fbcf18](https://github.com/cheminfo/pdb.cheminfo.org/commit/9fbcf180c4d68ec6d75504a875843b9ee8197b79))
...
* **deps:** take react-cheminfo 0.9.0 ([423baf0](https://github.com/cheminfo/pdb.cheminfo.org/commit/423baf07be88b9f353c0706ba61cc36cd20690aa))
...
* **docker:** copy the checkout so the About can name the commit ([b963551](https://github.com/cheminfo/pdb.cheminfo.org/commit/b963551f0c421f06954c26a645f0a85e632569a4))
